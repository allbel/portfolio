            ...
            <div className={sm.container}>
                <div className={s.text}>
                    ...
                    <div className={s.desc}>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In nunc odio, rutrum vel consequat vel, efficitur id felis. Vestibulum dolor tellus, pretium non nisi vel, pellentesque suscipit nunc. Phasellus sed interdum mi.</p>
                    </div>
